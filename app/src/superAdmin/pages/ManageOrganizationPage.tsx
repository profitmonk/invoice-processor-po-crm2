...
import {
  ...
  addUserToOrganizationSuperAdmin,
...
export default function ManageOrganizationPage() {
  ...
  const handleAddUser = async () => {
    try {
      await addUserToOrganizationSuperAdmin({
        organizationId: id!,
        email: userData.email,
        password: userData.password || undefined, // Auto-generate if empty
        role: userData.role as any,
      });
      setMessage({ type: 'success', text: 'User created and ready to login' });
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      Auto-generated password will be shown once
                    </p>
                  </div>
                  <div>
                    <Label>Role</Label>
